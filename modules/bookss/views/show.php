...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('bookss/manage', 'View All Bookss', array("class" => "button alt"));
        echo anchor('bookss/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="two-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            ...
            <div><span>Author</span><span><?= $author ?></span></div>
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('bookss/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a books record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
